  ...
  return (
    <section className="bg-white py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="aparece-hijos mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {reviews.map((review) => (
            <figure
              key={review.id}
              className="flex flex-col rounded-2xl bg-slate-50 p-6 ring-1 ring-slate-100 transition-all hover:shadow-lg hover:ring-amber-100"
            >
